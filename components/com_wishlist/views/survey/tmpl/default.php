...
<?php else:?>
	<div class="container">
		<h1 class="checkout-survey__title"><?php echo JText::_('COM_WISHLIST_SURVEY_TITLE');?></h1>
		<p class="checkout-survey__help-text"><?php echo JText::_('COM_WISHLIST_SURVEY_MSG');?></p>
		<form action="<?php echo JRoute::_('index.php?option=com_wishlist&task=confirm'); ?>"
			method="post" name="adminForm" id="adminForm">
			<input type="hidden" name="products" value="<?php echo $this->checkoutProducts;?>">
			<div class="form-group">
				<label class="question-text required"><?php echo JText::_('COM_WISHLIST_SURVEY_Q1');?></label>
				<label class="answer-text">
					<input type="radio" name="q1" value="Excelente" required>
					<span><?php echo JText::_('COM_WISHLIST_SURVEY_ANS1');?></span>
				</label>
				<label class="answer-text">
					<input type="radio" name="q1" value="Buena">
					<span><?php echo JText::_('COM_WISHLIST_SURVEY_ANS2');?></span>
				</label>
				<label class="answer-text">
					<input type="radio" name="q1" value="Mala">
					<span><?php echo JText::_('COM_WISHLIST_SURVEY_ANS3');?></span>
				</label>
				<label class="answer-text">
					<input type="radio" name="q1" value="Muy Mala">
					<span><?php echo JText::_('COM_WISHLIST_SURVEY_ANS4');?></span>
				</label>
			</div>
			<div class="form-group">
				<label class="question-text required"><?php echo JText::_('COM_WISHLIST_SURVEY_Q2');?></label>
				<label class="answer-text">
			...
			<div class="form-group">
				<label class="question-text required"><?php echo JText::_('COM_WISHLIST_SURVEY_Q3');?></label>
				<label class="answer-text">
			...
			<div class="form-group">
				<label class="question-text required"><?php echo JText::_('COM_WISHLIST_SURVEY_Q4');?></label>
				<label class="answer-text">
			...
			<div class="form-group">
				<label class="question-text required"><?php echo JText::_('COM_WISHLIST_SURVEY_Q5');?></label>
				<label class="answer-text">
			...
			<div class="form-group">
				<label class="question-text required"><?php echo JText::_('COM_WISHLIST_SURVEY_Q6').$this->pmr_name.'?';?></label>
				<label class="answer-text">
			...
			<div class="form-group">
				<label class="question-text required"><?php echo JText::_('COM_WISHLIST_SURVEY_Q7');?></label>
				<label class="answer-text">
			...
			<div>
				<label class="question-text"><?php echo JText::_('COM_WISHLIST_SURVEY_Q8');?></label>
				<textarea id="comments-text" name="q8"></textarea>
			</div>
			<div class="submit">
				<input type="submit" class="next-btn" value="<?php echo JText::_('COM_WISHLIST_CONTINUE');?>">
			</div>
		</form>
	</div>
<?php endif;?>