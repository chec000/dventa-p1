...
<div id="j-main-container" class="span10">
  <form action="<?php echo JRoute::_('index.php?option=com_catalog&view=categories'); ?>"
      ...
      <thead>
        <tr>
          <th width="2%" class="nowrap center hidden-phone">
            <?php echo JHtml::_('grid.sort', 'VIEW_CATEGORIES_DEFAULT_TABLE_ID','a.id', $listDirn, $listOrder); ?>
          </th>          
          <th class="product_title" width="15%">
            <?php echo JHtml::_('grid.sort', 'VIEW_CATEGORIES_DEFAULT_TABLE_NAME', 'a.name', $listDirn, $listOrder); ?>
          </th>
          <th width="10%" class="product_img">
            <?php echo JText::_('VIEW_CATEGORIES_DEFAULT_TABLE_UPLOAD'); ?>
          </th>        
          <th width="10%" class="product_img">
            <?php echo JHtml::_('grid.sort', 'VIEW_CATEGORIES_DEFAULT_TABLE_IMAGE','a.file_name'); ?>
          </th>        
          <th class="product_price">
            <?php echo JHtml::_('grid.sort', 'VIEW_CATEGORIES_DEFAULT_TABLE_DESC','a.description', $listDirn, $listOrder); ?>
          </th>
        </thead>
        <tbody>
          <?php foreach ($this->items as $i => $item):?>      
           ...
           <td>
            <a href="<?php echo JRoute::_('index.php?option=com_catalog&task=category&id='.(int) $item->id); ?>" class="btn btn-micro">
              <span class="icon-upload"></span>
            </a>
          </td>            
          <td>
            <img src="<?php echo JURI::Root(false).'/'.$item->file_name;?>">
          </td>  
          <td>
