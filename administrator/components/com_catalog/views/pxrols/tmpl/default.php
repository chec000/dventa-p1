...
<div id="j-main-container" class="span10">
  <form action="<?php echo JRoute::_('index.php?option=com_catalog&view=pxrols'); ?>"
      ...
      <thead>
        <tr>
          ...
          <th class="product_title" width="15%">
            <?php echo JHtml::_('grid.sort', 'PRODUCTS_TITLE', 'b.title', $listDirn, $listOrder); ?>
          </th>
          <th class="product_sku">
            <?php echo JHtml::_('grid.sort', 'PRODUCTS_SKU','b.sku', $listDirn, $listOrder); ?>
          </th>
          <th lass="product_description">
            <?php echo JHtml::_('grid.sort', 'PRODUCTS_DESCRIPTION', 'b.description'); ?>
          </th>        
          <th width="10%" class="product_img">
            <?php echo JHtml::_('grid.sort', 'PRODUCTS_IMAGE','b.file_name'); ?>
          </th>        
    ...
    <input type="hidden" name="task" value="productsxroles" />
