...
class catalogViewcproducts extends JViewLegacy
{
    /**
     *
     * @var type 
    ...
    protected function addToolbar()
    {
      ...
      {
        JToolbarHelper::addNew('cproduct.add');
      }

      if ($canDo->get('core.edit') && isset($this->items[0]))
      {
        JToolBarHelper::editList('cproduct.edit', 'JTOOLBAR_EDIT');
      }

      if ($canDo->get('core.delete') && isset($this->items[0]))
      {
        JToolBarHelper::deleteList('', 'cproduct.delete', 'JTOOLBAR_DELETE');
      }
    }
