...
<div class="row-fluid">
  <div class="span10 form-horizontal">
    <fieldset>
      ...
      <?php echo JHtml::_('bootstrap.addPanel', 'myTab','details', empty($this->item->id) ? JText::_('COM_DEALERS_NEW_DEALER', true) : JText::sprintf('COM_DEALERS_EDIT_DEALER', $this->item->id, true)); ?>
