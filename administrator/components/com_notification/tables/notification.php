...
class NotificationTableNotification extends JTable
{
	...
	public function __construct(&$db)
	{
		...
		parent::__construct('#__notification_content', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_notification.notification.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_notification/access.xml',
				"/access/section[@name='notification']/"
			);
			$default_actions = JAccess::getAssetRules('com_notification.notification.' . $array['id'])->getData();
			$array_jaccess   = array();
