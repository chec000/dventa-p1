 ...
 * @since  1.6
 */
class Checkout_StatusModelClogs extends JModelList
{
/**
	* Constructor.
	*
	...
	*/
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__core_checkout_log` AS a');
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('( a.id LIKE ' . $search . '  OR  a.applied_at LIKE ' . $search . '  OR  u.username LIKE ' . $search . ' )');
			}
		}
