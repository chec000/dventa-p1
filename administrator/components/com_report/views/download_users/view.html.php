 ...
 * @since  1.6
 */
class ReportViewDownload_users extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		$this->result = ReportHelper::getUserFieldsOrder();
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::custom('userfields.download', 'arrow-down-4', 'arrow-down-4', JText::_('COM_REPORT_CONFIRM_DOWNLOAD_CSV_BUTTON'), false);
