 ...
 * @since  1.6
 */
class ReportViewUserfields extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		ReportHelper::addSubmenu('userfields');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::custom('userfields.download', 'arrow-down-4', 'arrow-down-4', JText::_('COM_REPORT_DOWNLOAD_CSV_BUTTON'), false);
		...
		JHtmlSidebar::setAction('index.php?option=com_report&view=userfields');
	}
