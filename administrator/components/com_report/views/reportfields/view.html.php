 ...
 * @since  1.6
 */
class ReportViewReportfields extends JViewLegacy
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::custom('reportfields.download', 'arrow-down-4', 'arrow-down-4', JText::_('COM_REPORT_DOWNLOAD_CSV_BUTTON'), false);
