...
class checkoutViewcheckout extends JViewLegacy
{
    ...
    public function loadUser($data) {
        ...
        return  array(
            ...
            'num_ext' => isset($data['extNum']) ? $data['extNum'] : '',
            'num_int' => isset($data['intNum']) ? $data['intNum'] : '',
          ...
          'between_street1' => isset($data['between_street1']) ? $data['between_street1'] : '',
           'between_street2' => isset($data['between_street2']) ? $data['between_street2'] : '',
