...
<?php elseif(!$this->blacklist) :?>
    <div id="system-message-container">
    <div class="alert alert-error">
    <button type="button" class="close" data-dismiss="alert">×</button>
    <h4 class="alert-heading"><?php echo JText::_('COM_CHECKOUT_RELOAD_TITLE_ERR_BLACKLIST');?></h4>
    <div class="alert-message"><?php echo JText::_('COM_CHECKOUT_RELOAD_MSG_ERR_BLACKLIST');?></div>
    </div>
    </div>
    <div id="cart-view__actions">
    <a type="submit" id="cart-view__add-btn" href="index.php?option=com_cart"><?php echo JText::_('COM_CHECKOUT_BACK_BLACKLIST');?></a>
    <?php elseif(!$this->wallets) :?>
    <div id="system-message-container">
        <div class="alert alert-error">
            <button type="button" class="close" data-dismiss="alert">×</button>
            <h4 class="alert-heading"><?php echo JText::_('COM_CHECKOUT_RELOAD_TITLE_ERR_WALLETS');?></h4>
            <div class="alert-message"><?php echo JText::_('COM_CHECKOUT_RELOAD_MSG_ERR_WALLETS');?></div>
        </div>
    </div>
    <div id="cart-view__actions">
        <a type="submit" id="cart-view__add-btn" href="index.php?option=com_cart"><?php echo JText::_('COM_CHECKOUT_BACK_WALLETS');?></a>
        <?php elseif(!$this->stock['result']) :?>
        <div id="system-message-container">
            <div class="alert alert-error">
                <button type="button" class="close" data-dismiss="alert">×</button>
                <h4 class="alert-heading"><?php echo JText::_('COM_CHECKOUT_RELOAD_TITLE_ERR_STOCK');?></h4>
                <div class="alert-message"><?php echo $this->stock['message'];?></div>
            </div>
        </div>
        <div id="cart-view__actions">
            <a type="submit" id="cart-view__add-btn" href="index.php?option=com_cart"><?php echo JText::_('COM_CHECKOUT_BACK_STOCK');?></a>
        <?php else:?>
        <div id="system-message-container">
            <div class="alert alert-error">
                <button type="button" class="close" data-dismiss="alert">×</button>
                <h4 class="alert-heading"><?php echo JText::_('COM_CHECKOUT_RELOAD_TITLE_ERR');?></h4>
                <div class="alert-message"><?php echo JText::_('COM_CHECKOUT_RELOAD_MSG_ERR');?></div>
            </div>
        </div>
        <div id="cart-view__actions">
